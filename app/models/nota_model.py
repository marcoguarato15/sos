...
class Nota(db.Model):
    ...
    categoria_id = db.Column(db.ForeignKey("categoria.id"), nullable=False)
    categoria = db.relationship("Categoria", backref=db.backref("nota", lazy="joined"), foreign_keys=[categoria_id])